...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    tv4: {
      pass_prop: {
        ...
        src: ['test/fixtures/object_props/pass_a.json']
      },
      pass_many: {
        options: {
          fresh: true,
      ...
      fail_multi: {
        ...
        src: ['test/fixtures/object_props/fail_a.json']
      },
      fail_many_multi: {
        options: {
          fresh: true,
      ...
      fail_remote: {
        ...
        src: ['test/fixtures/remote/fail.json']
      },
      fail_remoteNotFound: {
        options: {
          fresh: true,
        ...
        src: ['test/fixtures/remote/pass.json']
      },
      pass_format: {
        options: {
          fresh: true,
        ...
        src: ['test/fixtures/format/pass.json']
      },
      fail_format: {
        options: {
          fresh: true,
        ...
        src: ['test/fixtures/format/fail.json']
      },
      pass_bulk: {
        options: {
          fresh: true,
        ...
        src: ['test/fixtures/bulk/pass.json', 'test/fixtures/bulk/pass.json']
      },
      fail_bulk: {
        options: {
          fresh: true,
        ...
        src: ['test/fixtures/bulk/fail.json']
      },
      pass_rootObject: {
        options: {
          fresh: true,
      ...
      pass_subError: {
        ...
        src: ['test/fixtures/subError/pass.json']
      },
      fail_subError: {
        options: {
          fresh: true,
      ...
      fail_subErrorMulti: {
        ...
        src: ['test/fixtures/subError/fail_deeper.json']
      },
      pass_values: {
        options: {
          fresh: true,
  ...
  grunt.registerTask('edit_02', [
    'eslint',
    'tv4:pass_values',
    'tv4:fail_valuesArray',
    'tv4:fail_valuesObject',
    'tv4:fail_valuesCallback'
  ]);
